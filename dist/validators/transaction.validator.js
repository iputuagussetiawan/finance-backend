...
exports.updateTransactionSchema =
    ...
    exports.bulkTransactionSchema =
    exports.bulkDeleteTransactionSchema =
    exports.baseTransactionSchema =
    exports.transactionIdSchema =
        void 0;
...
exports.baseTransactionSchema = zod_1.z.object({
    ...
    amount: zod_1.z.number().positive('Amount must be positive').min(1),
